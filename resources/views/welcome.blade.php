...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="http://localhost:8080/#page-top">Start Bootstrap</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form method="POST" action="{{ route('contact.confirm') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone_number" name="phone_number" type="text" value="{{ old('phone_number') }}" />
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="body" name="body" type="text" style="height: 200px;" >{{ old('body') }}</textarea>
                                <label for="body">お問い合わせ内容</label>
                                @if ($errors->has('body'))
                                    <p class="error-message">{{ $errors->first('body') }}</p>
                                @endif
                            </div>
                            <button class="btn btn-primary btn-xl" type="submit">入力内容確認</button>
                        </form>
                    </div>
                </div>
            </div>
