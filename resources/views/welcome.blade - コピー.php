        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <div>
                    ...
                    <img class="masthead-avatar mb-5" src="{{ asset('assets/img/dot_jiro.png')  }}" alt="..." />
                </div>
                <div>
                    <!-- Masthead Heading-->
                    <h1 class="masthead-heading text-uppercase mb-0">谷口　大次郎/ポートフォリオ</h1>
                    <!-- Icon Divider-->
                    ...
                    <!-- Masthead Subheading-->
                    <p class="masthead-subheading font-weight-light mb-0">プログラマー・エンジニア</p>
                </div>
            </div>
        </header>
        <!-- Portfolio Section-->
